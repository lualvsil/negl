...
const
  ...
  EGL_NO_CONTEXT* = cast[EGLContext](nil)
  EGL_NO_DISPLAY* = cast[EGLDisplay](nil)
  EGL_NO_SURFACE* = cast[EGLSurface](nil)
  ...
  EGL_DEFAULT_DISPLAY* = cast[EGLNativeDisplayType](nil)
  ...
  EGL_NO_IMAGE* = cast[EGLImage](nil)
